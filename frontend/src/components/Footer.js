...
const Footer = () => {
  return (
    <footer className='h-fit w-full bg-blue-500 py-28'>
      <div className='h-fit w-full max-w-[1024px] mx-auto flex flex-col md:flex-row md:justify-between gap-8  px-8'>
        <div className='w-full max-w-[400px] px-8 md:px-0 md:w-[300px] flex flex-col items-center md:text-start mx-auto gap-4'>
          <div className='bg-blue-200 w-full flex items-center justify-center lg:justify-start rounded-[8px] mb-4 py-8'>
            <img src={logo} alt='' className='h-[50px] w-fit object-contain mx-auto' />
          </div>        
          ...
          <div className='h-[1px] w-full bg-white/25'></div>
          <div className='w-full py-4 flex items-center justify-center md:justify-start'>
